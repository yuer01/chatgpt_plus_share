...
module.exports = {
	...
	"notifyUrl": {
		// 本地开发环境-支付回调地址
		"mp-d09a8771-fe72-4fbf-8510-c2fd14055eb3": "https://fc-mp-d09a8771-fe72-4fbf-8510-c2fd14055eb3.next.bspapp.com/uni-pay-co",
		// 线上正式环境-支付回调地址
		"mp-d09a8771-fe72-4fbf-8510-c2fd14055eb3": "https://fc-mp-d09a8771-fe72-4fbf-8510-c2fd14055eb3.next.bspapp.com/uni-pay-co",
	},
	...
	"wxpay": {
		...
		// 微信 - 扫码支付
		"native": {
			"appId": "wxe138116c8c85e553", // 可以是小程序或公众号或app开放平台下的应用的任意一个appid
			"secret": "bd2e8d7791ed205b0e9bd9998fb39e12", // secret
			"mchId": "1639303348", // 商户id
			"key": "Test0000000000000000000000000000", // v2的api key
			"pfx": fs.readFileSync(__dirname + '/wxpay/apiclient_cert.p12'), // v2需要用到的证书
			"v3Key": "Test0000000000000000000000000000", // v3的api key
			"appCertPath": path.join(__dirname, 'wxpay/apiclient_cert.pem'), // v3需要用到的证书
			"appPrivateKeyPath": path.join(__dirname, 'wxpay/apiclient_key.pem'), // v3需要用到的证书
			"version": 2, // 启用支付的版本 2代表v2版本 3 代表v3版本
		},
